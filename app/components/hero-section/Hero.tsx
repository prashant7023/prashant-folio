  ...
  return (
    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
        <Link target="_blank" className="inline-block w-full text-center cursor-pointer " href="https://drive.google.com/file/d/1sbpl00i7NAtSdmmbiZkFC2CQFvhLL1gN/view?usp=sharing">
            Download CV
          </Link>
        </motion.p>
