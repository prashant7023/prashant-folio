  ...
  return (
    ...
    >
      <div className="text sm:w-[60%]">
        ...
        >
        <Link target="_blank" className="inline-block w-full text-center cursor-pointer " href="https://drive.google.com/file/d/1Po08783GPtKlS7djsyvHKCxxMqZsgc5y/view?usp=sharing">
            Download CV
          </Link>
        </motion.p>
