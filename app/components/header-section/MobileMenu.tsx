  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 w-full">
        <Link
          className="p-4 flex-1 flex justify-center w-full rounded-xl h-fit text-2xl visited:bg-[#E3D3BE] bg-gradient-to-r from-[#d9d9d915] to-[#7373731f] std-backdrop-blur"
          target="_blank"
          href="https://linkedin.com/in/prashant7023"
        ...
        <div className="flex gap-3 w-full">
          <Link
            className="p-4 flex justify-center w-full rounded-xl h-fit text-2xl bg-gradient-to-r from-[#d9d9d915] to-[#7373731f] std-backdrop-blur"
            target="_blank"
            href="https://x.com/prashantsh7023"
            data-blobity-radius="10"
          >
          ...
          <Link
            className="p-4 flex justify-center w-full rounded-xl h-fit text-2xl bg-gradient-to-r from-[#d9d9d915] to-[#7373731f] std-backdrop-blur"
            target="_blank"
            href="https://drive.google.com/file/d/1sbpl00i7NAtSdmmbiZkFC2CQFvhLL1gN/view?usp=sharing"
            data-blobity-radius="10"
          >
