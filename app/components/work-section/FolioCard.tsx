...
export default function FolioCard({
  ...
  return (
    <div
      ref={ref}
      className={` flex-col w-full rounded-[20px] std-backdrop-blur bg-gradient-to-r from-[#d9d9d91f] to-[#7373731f] grid grid-cols-1 items-start lg:grid-cols-12 xl:flex gap-5 xl:gap-10 p-4 xl:p-6 duration-700 ${
    ...
    >
      ...
      <div className="flex flex-col gap-4 lg:col-span-7">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl sm:text-2xl xl:text-3xl font-bold">
            {title}
          </h2>
